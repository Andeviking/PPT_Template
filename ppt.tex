...
% xmu beamer
\usepackage[blue]{AndevikingBeamer}
\setbeamertemplate{navigation symbols}{}
\setbeamertemplate{caption}[numbered]

\author[Andeviking]{Andeviking}
\title{Andeviking的\textrm{Beamer}模板}
...
\begin{frame}
	...
	\begin{figure}[htpb]
		\begin{center}
			\includegraphics[width=0.2\linewidth]{pic/tongji-logo.png}
		\end{center}
	\end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
	\begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
		...
		\item 请使用bibtex编译引用
		\item GitHub项目地址为 \href{https://github.com/Andeviking/PPT_Template}{https://github.com/Andeviking/PPT\_Template}，如果有bug或者feature request可以去里面提issue
...
\begin{frame}
	\begin{itemize}
		\item 本模板参考自 \url{https://cn.overleaf.com/latex/templates/sudaiai-beamer-template/dzrthpbrzppc}\cite{origin1}\\
		      ...
		      \url{https://github.com/Submarinedriver/XiamenUniversity-Beamer-Theme}\cite{origin5}
	\end{itemize}
\end{frame}
